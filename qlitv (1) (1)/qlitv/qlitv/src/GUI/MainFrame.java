...
//
//		lblthuviensgu = new JLabel("         Welcome!");
...
//		lblTrangchu.setBackground(new Color(64, 64, 64));
		lblTrangchu.setBackground(new Color(255, 127, 80));
		...
		lblTrangchu.setBounds(0, 0, 187, 46);
...
//		lbldocgia.setBounds(0, 192, 187, 46);
		lbldocgia.setBounds(0, 130, 187, 46);
...
//		lbltacgia.setBounds(0, 251, 187, 46);
		lbltacgia.setBounds(0, 190, 187, 46);
...
//		lblnhaxuatban.setBounds(0, 310, 187, 46);
		lblnhaxuatban.setBounds(0, 250, 187, 46);
...
//		lblnhanvien.setBounds(0, 369, 187, 46);
		lblnhanvien.setBounds(0, 310, 187, 46);
...
//		lblphieumuon.setBounds(0, 428, 187, 46);
		lblphieumuon.setBounds(0, 370, 187, 46);
...
//		lblchung.setBounds(0, 601, 187, 46);
		lblchung.setBounds(0, 550, 187, 46);
...
//		lbldangxuat.setBounds(0, 675, 187, 46);
		lbldangxuat.setBounds(0, 610, 187, 46);
...
//		lblthongke.setBounds(0, 542, 187, 46);
		lblthongke.setBounds(0, 490, 187, 46);
...
//		lblphieunhap.setBounds(0, 487, 187, 46);
		lblphieunhap.setBounds(0, 430, 187, 46);
...
//		lblUser.setText("Hi  " + LoginForm.username);
		...
		lblNewLabel_5 = new JLabel("Mã Độc Giả");
...
*/
	...
	private void docgia() {
		...
		lblTendocgia.setBounds(80, 13, 91, 36);
...
//		pnTrangChu.add(lblNewLabel);
		...
		lblNewLabel.setIcon(new ImageIcon("img\\lib.png"));
		lblNewLabel.setBounds(0, 0, 1093, 735);
		pnTrangChu.add(lblNewLabel);
	}
...
*/
		...
		btnThemnxb.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				NhaXuatBan nxb = new NhaXuatBan(0, txtTennhaxuatban.getText(), txtdiachinxb.getText(), null);
		...
		btnsuanxb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (i > -1) {
					...
					NhaXuatBan nxb = new NhaXuatBan(vitri, txtTennhaxuatban.getText(), txtdiachinxb.getText(), null);
